...
# def intro_demo():
#     df_merged = df_tlt.merge(df_voo, on='Date', suffixes=['_tlt', '_voo'])
#     df_merged['Effective_return_tlt'] = df_merged['Adj Close_tlt'] / df_merged['Adj Close_tlt'].shift(-1) - 1
#     df_merged['Effective_return_voo'] = df_merged['Adj Close_voo'] / df_merged['Adj Close_voo'].shift(-1) - 1
#
#     df_merged.plot(x='Effective_return_tlt', y='Effective_return_voo', kind='scatter')
#     plt.show()
